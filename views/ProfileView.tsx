      ...
      <div className="bg-card border-b border-slate-800 p-4 sticky top-0 z-20 shadow-lg shadow-black/20">
        <div className="flex justify-between items-center max-w-md mx-auto">
          <div className="flex items-center gap-3">
            <img src="https://i.ibb.co/LdXLhscV/photo-2026-02-21-18-02-04.jpg" alt="Logo MI NUR BILAD" className="w-[38px] h-[38px] object-contain drop-shadow-md rounded text-[0]" />
            <div>
              <h1 className="font-bold text-white leading-tight">MI NUR BILAD</h1>
          ...
          <div className="divide-y divide-slate-700/50">
            ...
            <div className="p-4 flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-white font-medium">{user.workUnit || 'MI NUR BILAD'}</div>
              </div>
            </div>
          </div>
        </div>
