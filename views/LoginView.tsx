      ...
      <div className="w-full max-w-sm flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col items-center gap-3">
          <img 
            ...
            alt="Logo MI NUR BILAD" 
            className="w-24 h-24 object-contain rounded-xl drop-shadow-2xl animate-in fade-in zoom-in duration-700 hover:scale-105 transition-transform bg-white/5 p-1"
          />
          <div className="text-center flex flex-col items-center">
            <p className="text-slate-400 font-medium mb-1">Aplikasi Berbasis E-Lokasi Real Time</p>
            <h1 className="text-2xl font-bold text-white tracking-tight">MI NUR BILAD</h1>
          </div>
        </div>
        ...
        <div className="text-xs text-slate-500 text-center w-full">
          <p className="font-medium text-slate-400">@2026 Absen Digital MI NUR BILAD</p>
        </div>
      </div>
    </div>
  );
