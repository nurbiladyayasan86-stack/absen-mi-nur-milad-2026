...
const USERS_KEY = 'mi_nur_bilad_users';
const ATTENDANCE_KEY = 'mi_nur_bilad_attendance';

// GANTI LINK DI BAWAH INI DENGAN LINK PUBLIKASI CSV DARI GOOGLE SHEETS ANDA
const GOOGLE_SHEETS_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSx5nTVRFXXuuEqD3os9oPYCoH36JguwgXSFjLkS2bQf1yhrZMYU2E3t-qXwss_pfHGnBICq4aepas4/pub?gid=0&single=true&output=csv';
...
export const sendToGAS = async (payload: any) => {
  const GAS_URL = 'https://script.google.com/macros/s/AKfycbxTdeIVggZGzcr2FlV_s4HeLKReYovprzHUvj1IFc9gyg3-HxBWXfgkFtrSqg4kJ3Zv/exec';
  try {
...
const LIVE_ABSENSI_CSV = "https://docs.google.com/spreadsheets/d/e/2PACX-1vSx5nTVRFXXuuEqD3os9oPYCoH36JguwgXSFjLkS2bQf1yhrZMYU2E3t-qXwss_pfHGnBICq4aepas4/pub?gid=511285110&single=true&output=csv";
...
export const downloadMonthlyReport = (startDate: string, endDate: string) => {
  ...
  link.setAttribute("download", `laporan_absensi_mi_nur_bilad_${startDate}_sd_${endDate}.csv`);
